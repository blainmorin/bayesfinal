...
where $\mathbf{y}_{i,t}$ is a vector of indicators. $\mathbf{F}_{i,t}$ is a state transition matrix, which in our scenario is assumed to be equal to the identity matrix. Moreover, the latent process evolves such that the latent state at time $t$ is a function of the state at time $t-1$, for $t=2,...,T$:
